...
namespace cachesplain.Protocol
{
    ...
    public class MemcachedBinaryPacket
    {
        ...
        public IEnumerable<MemcachedBinaryOperation> Operations
        {
        ...
        /// </remarks>
        private MemcachedBinaryOperation ParsePacket(byte[] payload, int startIndex)
        {
        ...
        private string ParseKey(ArraySegment<Byte> segment)
        {
            var key = String.Empty;
        ...
        /// </remarks>
        private static bool IsMagic(byte firstByte)
        {
